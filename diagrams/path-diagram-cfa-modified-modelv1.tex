...
\begin{tikzpicture}[auto,scale=3,
	...
	rcorr/.style={<->,>=stealth', bend left=60},
...
\node [manifest] [above = 0.05 cm of g1] (q53) {Q5-3};
...
\node [manifest] [below = 0.15cm of q56] (q512) {Q5-12};

% Effective Learning
\node [latent] [above right = 3cm of sc] (el) {Eff. Learn.};
\node [manifest] [above = 1.5cm of el] (q49) {Q4-9};
\node [manifest] [left = 0.15cm of q49] (q45) {Q4-5};
\node [manifest] [left = 0.15cm of q45] (q44) {Q4-4};
\node [manifest] [left = 0.15cm of q44] (q43) {Q4-3};
\node [manifest] [right = 0.15cm of q49] (q411) {Q4-11};
\node [manifest] [right = 0.15cm of q411] (q415) {Q4-15};
\node [manifest] [right = 0.15cm of q415] (q418) {Q4-18};


% Interactive
\node [latent] [below = 6cm of sc] (in) {Interactive};
\node [ghost] [left= 1.86cm of in] (g2) {};
\node [manifest] [above= 0.05cm of g2] (q66) {Q6-6};
\node [manifest] [above = 0.15cm of q66] (q65) {Q6-5};
\node [manifest] [above = 0.15cm of q65] (q62) {Q6-2};
\node [manifest] [below= 0.05cm of g2] (q67) {Q6-7};
...
\node [ghost] [below = 1.5cm of en] (g3) {};\
\node [manifest] [left = -0.15cm of g3] (q75) {Q7-5};
\node [manifest] [left = 0.15cm of q75] (q74) {Q7-4};
\node [manifest] [left = 0.15cm of q74] (q72) {Q7-2};
\node [manifest] [right = -0.15cm of g3] (q77) {Q7-7};
\node [manifest] [right = 0.15cm of q77] (q78) {Q7-8};
\node [manifest] [right = 0.15cm of q78] (q714) {Q7-14};
...
\draw[rcorr] (q43.north) to (q44.north);
\draw[lcorr] (q55.west) to (q56.west);
\draw[lcorr] (q52.west) to (q56.west);
\draw[lcorr] (q62.west) to (q68.west);
\draw[ofcorr] (q77.south) to (q78.south);
